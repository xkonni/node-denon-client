...
class DenonClient extends Connection {
  ...
  constructor(host,port=23) {
    ...
    this.regExTable = {
      ...
      'zone1': {
        ...
        /**
         * @event zone1Changed
         * @param {Zone1Options} zone1Status The current zone1 status
         */
        emit: 'zone1Changed'
      },
      'zone2': {
        ...
        /**
         * @event zone2Changed
         * @param {Zone2Options} zone2Status The current zone2 status
         */
        emit: 'zone2Changed'
      }
    };
  ...
  /**
   * Returns the current zone 1 status of the Denon AVR.
   *
   * @method getZone1
   * @return {Promise} [A response]
   */
